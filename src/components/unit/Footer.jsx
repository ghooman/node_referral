                ...
                <div className="footer__bottom">
                    <div className='footer__bottom__left'>
                        ...
                        <div className='link-content'>
                            <Link to="/" target='_blank' rel="noopener noreferrer">회사소개</Link>
                            <small>|</small>
                            <Link to="/" target='_blank' rel="noopener noreferrer">이용약관</Link>
                            <small>|</small>
                            <Link to="/" target='_blank' rel="noopener noreferrer">개인정보처리방침</Link>
                            <small>|</small>
                            <Link to="/" target='_blank' rel="noopener noreferrer">마케팅 수신</Link>
                        </div>
                    </div>
                                        ...
                                        <div className="slide-item">
                                            <div className='slide-item__img-com'>
                                                ...
                                                <dl className='slide-item__img-com__tit'>
                                                    <dt>hash : <span>{formatHash(item.hash)}</span></dt>
