...
// style
import '../styles/pages/RefferalEarningList.scss';
                    ...
                    <div class="custom-select">
                        ...
                        <div className='custom-select__sales-list'>
                            <button type="button" class="custom-select__btn">
                                <span>kimchumzi@nisoft.kr</span>
                                <i class="custom-select__arrow"></i>
                            </button>
                            <small>의 판매 기록</small>
                        </div>
                        <ul class="custom-select__list">
                            <li class="is-selected">kimchumzi@nisoft.kr</li>
            ...
            <div className="table-section-inner">
                ...
                data.map((item, index) => (
                    ...
                    <div className="list-item__row">
                        <div className="col"><span className="status">{item.status}</span></div>
